...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: RequestWaitingWidget.routeName,
          path: RequestWaitingWidget.routePath,
          builder: (context, params) => RequestWaitingWidget(
            riderdoc: params.getParam(
              'riderdoc',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['riding'],
            ),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => DriversWidget(
            user: params.getParam(
              ...
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['user_collection'],
            ),
        ...
        FFRoute(
          name: ShowProfileWidget.routeName,
          path: ShowProfileWidget.routePath,
          builder: (context, params) => ShowProfileWidget(),
        ),
        FFRoute(
          name: VerfifyPageWidget.routeName,
          path: VerfifyPageWidget.routePath,
          builder: (context, params) => VerfifyPageWidget(
        ...
        FFRoute(
          name: SendVerificationWidget.routeName,
          path: SendVerificationWidget.routePath,
          builder: (context, params) => SendVerificationWidget(),
        ),
        FFRoute(

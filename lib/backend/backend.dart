...
import 'schema/riding_record.dart';
...
export 'schema/riding_record.dart';
...
/// Functions to query RidingRecords (as a Stream and as a Future).
Future<int> queryRidingRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      RidingRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<RidingRecord>> queryRidingRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      RidingRecord.collection,
      RidingRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<RidingRecord>> queryRidingRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>

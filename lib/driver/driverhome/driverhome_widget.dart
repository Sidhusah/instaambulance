...
import 'driverhome_model.dart';
export 'driverhome_model.dart';
                  ...
                  Material(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            16.0, 16.0, 16.0, 16.0),
                        child: StreamBuilder<List<RidingRecord>>(
                          stream: queryRidingRecord(),
                          builder: (context, snapshot) {
                            ...
                            List<RidingRecord> columnRidingRecordList =
                                snapshot.data!;

                            return Column(
                              mainAxisSize: MainAxisSize.max,
                              children: List.generate(
                                  columnRidingRecordList.length, (columnIndex) {
                                final columnRidingRecord =
                                    columnRidingRecordList[columnIndex];
                                return StreamBuilder<UserCollectionRecord>(
                                  stream: UserCollectionRecord.getDocument(
                                      columnRidingRecord.userRef!),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                    if (!snapshot.hasData) {
                                      return Center(
                                        ...
                                        Container(
                                          ...
                                          child: ClipRRect(
                                            borderRadius:
                                                BorderRadius.circular(30.0),
                                            child: Image.network(
                                              rowUserCollectionRecord.photoUrl,
                                              width: 60.0,
                                              height: 60.0,
                                              fit: BoxFit.cover,
                                            ),

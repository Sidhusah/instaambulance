...
class DriversWidget extends StatefulWidget {
  ...
  static String routePath = '/Driver';
...
class _DriversWidgetState extends State<DriversWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<RidingRecord>(
      stream: RidingRecord.getDocument(widget.rideref!),
      builder: (context, snapshot) {
        ...
        final driversRidingRecord = snapshot.data!;
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            body: StreamBuilder<UserCollectionRecord>(
              stream: UserCollectionRecord.getDocument(widget.user!),
              builder: (context, snapshot) {
                // Customize what your widget looks like when it's loading.
                if (!snapshot.hasData) {
                  return Center(
                                ...
                                Align(
                                  ...
                                  child: Container(
                                    ...
                                    child: FlutterFlowGoogleMap(
                                      ...
                                      markers: functions
                                          .listlocations(
                                              driversRidingRecord.userLocation!,
                                              driversRidingRecord
                                                  .driverLocation!)
                                          .map(
                                            ...
                                            children: [
                                              Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    'Contact:- ${containerUserCollectionRecord.phoneNumber}',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .labelSmall
                                                        .override(

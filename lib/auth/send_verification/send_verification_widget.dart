...
import 'send_verification_model.dart';
export 'send_verification_model.dart';

class SendVerificationWidget extends StatefulWidget {
  const SendVerificationWidget({super.key});

  static String routeName = 'sendVerification';
  static String routePath = '/sendVerification';
...
class _SendVerificationWidgetState extends State<SendVerificationWidget> {
  late SendVerificationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SendVerificationModel());
